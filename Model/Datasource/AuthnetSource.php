<?php
    ...
    class AuthnetSource extends DataSource {
        ...
        /**
         *
         * These fields are often defined in the data set, but don't need to be
         * sent to Authnet
         *
         * @var array
         */
        ...
        /**
         *
         * Set configuration and establish HttpSocket with appropriate
         * test/production url.
         *
         * @param config an array of configuratives to be passed to the
         * constructor to overwrite the default
         */
        ...
        /**
         *
         * Not currently possible to read data posted authorize.net. Method not
         * implemented.
         *
         */
        ...
        public function update(&$Model, $fields = null, $values = null) {
            ...
            if ((float)$data['amount'] >= 0) {
                ...
                // Authorize assumes we want to send a positive number for a
                // credit transcation (how much to credit)
        ...
        /**
         *
         * Translate keys to a value Authorize.net expects in posted data, as
         * well as encapsulating where relevant. Returns false
        ...
        private function __parseResponse(&$Model, $response, $input = null, $url = null) {
            ...
            if ($response["response_code"] == 1) {
                ...
                if (array_key_exists($response["response_subcode"], $subcodesToFields)) {
                    ...
                    $Model->invalidate('declined', array(
                        $status,
        ...
        private function __request(&$Model, $data) {
            ...
            $this->Http->reset();
            $response = $this->Http->post($url, $data, array('header' => array(
                    'Connection' => 'close',
            ...
            if (isset($Model->logModel) && is_object($Model->logModel)) {
                ...
                // this is a convenient way to pass IDs around, would have to be
                // handled in the logModel
